...
function houses_validateData(){
	...
	if($j('#house_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> House number", close: function(){ /* */ $j('[name=house_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field features can't be empty */
	if($j('#features').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Features", close: function(){ /* */ $j('[name=features]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field rent can't be empty */
	if($j('#rent').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Rent", close: function(){ /* */ $j('[name=rent]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
